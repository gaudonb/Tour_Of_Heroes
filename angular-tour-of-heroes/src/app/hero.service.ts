...
export class HeroService {
	...
	/** PUT: Updates a hero on the server*/
	...
	/** DELETE: Deletes a hero on the server */
	...
	/** GET: searches for heros by name */
